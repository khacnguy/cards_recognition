...
image_path   = "./dataset/test/000382481.jpg"
...
detect_image(yolo, image_path, "./IMAGES/detect1.jpg", input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
