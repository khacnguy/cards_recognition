...
#data_dir = r'D:\cards_recognition\creating_datasets\scene'
data_dir = 'dataset/'
Dataset_train = "dataset/train.txt"
Dataset_test = "dataset/test.txt"
Dataset_names_path = "dataset/card.names"
...
def ParseXML(img_folder, file):
    for xml_file in glob(img_folder+'/*.xml'):
